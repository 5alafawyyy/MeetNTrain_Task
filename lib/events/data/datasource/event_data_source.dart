...
import 'package:meet_n_train_task/core/network/error_message_model.dart';
import 'package:meet_n_train_task/events/data/models/event_model.dart';
...
class EventRemoteDataSource extends BaseEventRemoteDataSource {
  ...
  Future<List<EventModel>> getEvents() async {
    ...
    if (response.statusCode == 200) {
      return List<EventModel>.from((response.data as List).map(
        (e) {
